...
def get_baseline_substitution():
    baseline = {
        "__d_end_length__":(1.5/math.cos(math.radians(41))/2.)/2.4,
...
class Config(object):
    def __init__(self):
        ...
        self.find_rf_parameters = {
            ...
            "do_co_scan":False,
            "delta_energy_list":[2.5, 2.7, 2.9, 3.1, 3.3, 3.5],
            "phasing_subs_overrides":{"__n_turns__":2.1, "__no_field_maps__":"// "},
