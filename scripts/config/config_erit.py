...
class Config(object):
    def __init__(self):
        ...
        self.find_tune = {
            ...
            "subs_overrides":{"__n_turns__":2.1, "__ascii__":False},
            "root_batch":0,
            "delta_x":2.,
            "delta_y":1.,
            "max_n_cells":0.1,
        ...
        self.run_control = {
            ...
            "output_dir":os.path.join(os.getcwd(), "output/erit"),
        }

        self.tracking = {
            "mpi_exe":None, #os.path.expandvars("${OPAL_ROOT_DIR}/external/install/bin/mpirun"),
            "n_cores":4,
            "lattice_file":os.path.join(os.getcwd(), "lattice/kurri_main_ring/Kurri_ERIT_Ring.in"),
