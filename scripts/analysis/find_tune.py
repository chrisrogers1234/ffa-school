...
class TuneFinder(object):
    ...
    def do_plots(self, i, axis1, axis2, finder):
        """
        Plot the ellipse used to calculate the tune
        - i: indexes the element in config.substitutions_list
        - axis1: horizontal axis of the plot
        - axis2: vertical axis of the plot
        - finder: DPhiTuneFinder object
        """
